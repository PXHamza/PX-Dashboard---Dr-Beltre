/**
 * Qualification.gs — MMT lead-qualification rule.
 *
 * A lead is considered UNQUALIFIED only when its Lead Category is
 * "Unqualified". Every other stage — New Lead, Call Booked, Meeting
 * Cancelled, No show, Second Meeting, Custom Follow Up, Deal Won and
 * Deal Lost — counts as QUALIFIED.
 */
